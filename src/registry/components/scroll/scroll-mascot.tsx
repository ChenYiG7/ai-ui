...
import { type PointerEvent, type UIEvent, useEffect, useRef, useState } from 'react';
    ...
    >
      ...
      >
        <div className="sticky top-0 flex h-full items-center justify-center overflow-hidden px-5 @md:px-10">
          <div
            aria-hidden
            className="absolute inset-0 bg-[radial-gradient(circle_at_28%_45%,rgba(163,230,53,0.10),transparent_36%),linear-gradient(145deg,#151518,#09090b)]"
          />
            ...
            >
              <motion.div style={reduceMotion ? undefined : { x: smoothX, y: smoothY }}>
                <svg viewBox="0 0 160 190" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <path
                    d="M43 80C43 58.46 59.118 43 80 43C100.882 43 117 58.46 117 80V112H43V80Z"
                    fill="#17171a"
                  />
                  ...
                  <path
                    d="M68 99C74.5 104 85.5 104 92 99"
                    stroke="white"
                    strokeOpacity="0.6"
                    strokeWidth="3"
                    strokeLinecap="round"
