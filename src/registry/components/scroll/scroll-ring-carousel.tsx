...
export function ScrollRingCarousel({ items, radius = 150, className }: ScrollRingCarouselProps) {
    ...
    >
      ...
      >
        <div className="sticky top-0 flex h-full flex-col items-center justify-center overflow-hidden pb-12 @md:pb-16">
          <div
            aria-hidden
            className="absolute inset-x-[15%] top-1/2 h-px bg-gradient-to-r from-transparent via-white/15 to-transparent"
          />
          <div
            style={{ perspective: '760px' }}
            className="relative h-[clamp(112px,48cqh,208px)] w-[clamp(96px,40cqh,176px)]"
          >
            <div
              ref={ringRef}
