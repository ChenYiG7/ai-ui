      ...
      <div className="relative min-h-full px-4 pt-4 @md:px-7 @md:pt-7">
        {items.map((item, index) => (
          ...
          >
            <div
              aria-hidden
              className="absolute inset-0 bg-[radial-gradient(circle_at_80%_12%,rgba(255,255,255,0.14),transparent_38%),linear-gradient(145deg,transparent,rgba(0,0,0,0.38))]"
            />
