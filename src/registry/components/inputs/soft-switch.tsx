    ...
    >
      ...
      <span className="min-w-0 flex-1">
        ...
        {description && (
          <span
            id={`${id}-description`}
            className="mt-1 block text-[10px] leading-relaxed text-zinc-400 @md:text-xs"
          >
            {description}
          </span>
        )}
      ...
      <span
        ...
        className={cn(
          ...
          active &&
            'border-emerald-200/25 bg-emerald-200/20 shadow-[inset_0_2px_5px_#0005,0_0_20px_#a7f3d015]',
        )}
      >
        <span
          className={cn(
        ...
        >
          <span
            className={cn('h-1.5 w-0.5 rounded-full bg-zinc-600', active && 'bg-emerald-900')}
          />
        </span>
      </span>
    </label>
