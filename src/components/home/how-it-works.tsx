import { ArrowUpRight, Bot, ClipboardCopy, type LucideIcon, MousePointer2 } from 'lucide-react';
...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      aria-label="如何使用组件词典"
      className="scroll-mt-24 border-b border-line bg-white/[0.012]"
    >
      <ol className="page-shell grid divide-y divide-line md:grid-cols-3 md:divide-x md:divide-y-0">
        {steps.map((step, index) => (
          <li
            key={step.title}
            className="flex gap-4 py-7 md:px-6 md:py-8 md:first:pl-0 md:last:pr-0 lg:px-9"
          >
